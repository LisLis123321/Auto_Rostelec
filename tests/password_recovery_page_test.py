...
def test_should_open_password_recovery_page(google_chrome_browser):
...
@pytest.mark.password_recovery
@pytest.mark.positive
def test_should_click_password_recovery_tab_email(google_chrome_browser):
...
@pytest.mark.password_recovery
@pytest.mark.positive
def test_should_click_password_recovery_tab_phone(google_chrome_browser):
    page = PasswordRecoveryPage(google_chrome_browser)
...
@pytest.mark.password_recovery
@pytest.mark.positive
def test_should_click_password_recovery_tab_login(google_chrome_browser):
    page = PasswordRecoveryPage(google_chrome_browser)
...
@pytest.mark.password_recovery
@pytest.mark.positive
def test_should_click_password_recovery_tab_personal_account(google_chrome_browser):
    page = PasswordRecoveryPage(google_chrome_browser)
...
# RTC-027
def test_should_reload_captcha_by_click(google_chrome_browser):
    page = PasswordRecoveryPage(google_chrome_browser)
...
# RTC-028
def test_should_password_recovery_click_on_back_button(google_chrome_browser):
    page = PasswordRecoveryPage(google_chrome_browser)
...
@pytest.mark.password_recovery
@pytest.mark.positive
def test_should_password_recovery_by_email(google_chrome_browser):
...
def test_should_not_password_recovery_with_wrong_captcha(google_chrome_browser):
    page = PasswordRecoveryPage(google_chrome_browser)
    page.enter_username(valid_email)
...
@pytest.mark.password_recovery
@pytest.mark.negative
def test_should_not_password_recovery_with_wrong_email(google_chrome_browser):
    page = PasswordRecoveryPage(google_chrome_browser)
...
@pytest.mark.password_recovery
@pytest.mark.negative
def test_should_not_password_recovery_with_wrong_phone(google_chrome_browser):
    page = PasswordRecoveryPage(google_chrome_browser)
...
@pytest.mark.password_recovery
@pytest.mark.negative
def test_should_not_password_recovery_with_wrong_login(google_chrome_browser):
    page = PasswordRecoveryPage(google_chrome_browser)
...
@pytest.mark.password_recovery
@pytest.mark.negative
def test_should_not_password_recovery_with_wrong_personal_account(google_chrome_browser):
    page = PasswordRecoveryPage(google_chrome_browser)
