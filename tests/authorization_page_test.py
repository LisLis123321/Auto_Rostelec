...
def test_should_open_authorization_page(google_chrome_browser):
...
@pytest.mark.authorization
@pytest.mark.positive
def test_should_open_authorization_tab_email(google_chrome_browser):
    page = AuthorizationPage(google_chrome_browser)
...
@pytest.mark.authorization
@pytest.mark.positive
def test_should_open_authorization_tab_phone(google_chrome_browser):
    page = AuthorizationPage(google_chrome_browser)
...
@pytest.mark.authorization
@pytest.mark.positive
def test_should_open_authorization_tab_login(google_chrome_browser):
    page = AuthorizationPage(google_chrome_browser)
...
@pytest.mark.authorization
@pytest.mark.positive
def test_should_open_authorization_tab_personal_account(google_chrome_browser):
    page = AuthorizationPage(google_chrome_browser)
...
@pytest.mark.parametrize("username", ["+79217777777", valid_email, "valid_login", "269750005232"],
                         ids=["RTC-009-01 phone", "RTC-009-02 E-mail", "RTC-009-03 login", "RTC-009-04 ls"])
def test_should_change_tabs(google_chrome_browser, username):
    page = AuthorizationPage(google_chrome_browser)
...
@pytest.mark.authorization
@pytest.mark.positive
def test_should_authorized_by_vk(google_chrome_browser):
    page = AuthorizationPage(google_chrome_browser)
...
@pytest.mark.authorization
@pytest.mark.positive
def test_should_authorized_by_odhoklassniky(google_chrome_browser):
    page = AuthorizationPage(google_chrome_browser)
...
@pytest.mark.authorization
@pytest.mark.positive
def test_should_authorized_by_mail(google_chrome_browser):
    page = AuthorizationPage(google_chrome_browser)
...
@pytest.mark.authorization
@pytest.mark.positive
def test_should_authorized_by_yandex(google_chrome_browser):
    page = AuthorizationPage(google_chrome_browser)
...
@pytest.mark.authorization
@pytest.mark.positive
def test_should_authorized_by_email(google_chrome_browser):
    page = AuthorizationPage(google_chrome_browser)
...
def test_should_not_authorized_with_invalid_email(google_chrome_browser):
...
@pytest.mark.authorization
@pytest.mark.negative
def test_should_not_authorized_with_invalid_password(google_chrome_browser):
    page = AuthorizationPage(google_chrome_browser)
