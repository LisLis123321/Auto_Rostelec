...
def test_should_open_registration_page(google_chrome_browser):
...
class TestRegistration:
    ...
    def test_should_registration_by_email(self, google_chrome_browser):
...
def test_should_not_registration_with_invalid_format_lastname(google_chrome_browser, lastname):
    auth_page = AuthorizationPage(google_chrome_browser)
    auth_page.click_on_registration_button()
    assert auth_page.get_current_url() == "/auth/realms/b2c/login-actions/registration"
...
def test_should_not_registration_invalid_format_firstname(google_chrome_browser, firstname):
    page = AuthorizationPage(google_chrome_browser)
    page.click_on_registration_button()
    assert page.get_current_url() == "/auth/realms/b2c/login-actions/registration"
...
def test_should_not_registration_with_invalid_format_phone(google_chrome_browser, phone):
    page = AuthorizationPage(google_chrome_browser)
    page.click_on_registration_button()
    assert page.get_current_url() == "/auth/realms/b2c/login-actions/registration"
...
@pytest.mark.parametrize("email", ["", "@", "@.", ".", generate_cyrillic_string(20),
                         ...
                         ids=['RTC-035-1) empty line', 'RTC-035-2) at', 'RTC-035-3) at point',
                              ...
                              'RTC-035-7) digits'])
def test_should_not_registration_with_invalid_format_email(google_chrome_browser, email):
    page = AuthorizationPage(google_chrome_browser)
    page.click_on_registration_button()
    assert page.get_current_url() == "/auth/realms/b2c/login-actions/registration"
...
def test_should_not_registration_with_living_account(google_chrome_browser, living_email):
    page = AuthorizationPage(google_chrome_browser)
    page.click_on_registration_button()
    assert page.get_current_url() == "/auth/realms/b2c/login-actions/registration"
...
@pytest.mark.registration
@pytest.mark.negatvie
def test_should_not_registration_when_password_diff_password_confirm(google_chrome_browser):
    page = AuthorizationPage(google_chrome_browser)
    page.click_on_registration_button()
    assert page.get_current_url() == "/auth/realms/b2c/login-actions/registration"
